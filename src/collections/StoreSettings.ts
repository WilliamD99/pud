  ...
  fields: [
    {
      ...
      admin: {
        description: 'Set the operating day and time for the store. Leave empty to set as day off.',
      },
      hooks: {},
      validate: ((value) => {
      ...
      fields: [
        {
          name: 'platform',
          type: 'select',
          options: ['facebook', 'instagram', 'twitter', 'youtube', 'linkedin', 'tiktok', 'website'],
        },
        {
          name: 'url',
          type: 'text',
